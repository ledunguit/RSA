...
#else
#define DLL_EXPORT // Define it as empty for non-Windows platforms if needed
#endif
#endif
 
// Declare functions with extern "C" and char type to prevent name mangling in C++,
extern "C" {
    DLL_EXPORT void GenerateAndSaveRSAKeys(int keySize, const char* chrformat, const char* chrprivateKeyFile, const char* chrpublicKeyFile);
    DLL_EXPORT void RSAencrypt(const char* chrpublicKeyFile, const char* chrpublicKeyFormat, const char* chrplaintextFile, const char* chrplaintextFormat,
                const char* chrcipherFile, const char* chrcipherFormat);
    DLL_EXPORT void RSAdecrypt(const char* privateKeyFile, const char* privateKeyFormat, const char* cipherFile, const char* cipherFormat,
                const char* plaintextFile, const char* plaintextFormat);
}
...
void RSAencrypt(const char* publicKeyFile, const char* publicKeyformat, const char* plaintextFile, const char* plaintextFormat, const char* cipherFile, const char* cipherFormat) {
    // Encryption process handling different formats
};
...
void RSAdecrypt(const char* privateKeyFile, const char* privateKeyformat, const char* cipherFile, const char* cipherFormat, const char* plaintextFile, const char* plaintextFormat) {
    // Decryption process handling different formats
};
